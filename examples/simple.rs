...
fn main() {
    ...
    let random_f32 = random::f32().unwrap();
    println!("random f32: {}", random_f32);

    let random_check = random::f32().unwrap();
    println!(
        "random f32 check: {} & {}",
        random_check,
    ...
    let random_f64 = random::f64().unwrap();
    println!("random f64: {}", random_f64);

    let random_i16 = random::i16().unwrap();
    println!("random i16: {}", random_i16);

    let random_i32 = random::i32().unwrap();
    println!("random i32: {}", random_i32);

    let random_i64 = random::i64().unwrap();
    println!("random i64: {}", random_i64);

    let random_u16 = random::u16().unwrap();
    println!("random u16: {}", random_u16);

    let random_u32 = random::u32().unwrap();
    println!("random u32: {}", random_u32);

    let random_u64 = random::u64().unwrap();
    println!("random u64: {}", random_u64);
    ...
    let random_range_e = random::range_i64(8000..24000).unwrap();
    println!("random range e: {}", random_range_e);

    let random_range_f = random::range_u64(8000..24000).unwrap();
